...
\
  ...
  Settings: {
    ...
    CustomCSS: {
      ...
      Preview: "预览",
      Previewing: "预览中",
      PreviewApplied: "已应用临时预览",
      PreviewCancelled: "已取消预览",
      PreviewEmpty: "请先输入 CSS 或选择一个云端主题",
      CloudTheme: "云端主题",
      CloudThemePlaceholder: "选择云端主题",
      LocalThemeOption: "使用本地主题",
      LocalThemeRestored: "已恢复本地主题",
      CloudThemeLoading: "正在加载云端主题...",
      CloudThemeLoadFailed: "云端主题加载失败",
      CloudThemeCssLoading: "正在拉取主题 CSS...",
      PrimaryColor: "主色",
      SecondaryColor: "副色",
      LightMode: "Light",
      DarkMode: "Dark",
      ThemeLoaded: (name: string) => `已载入主题：${name}`,
      ThemeLoadFailed: (name: string) => `主题加载失败：${name}`,
  ...
  CustomProvider: {
    ...
    Toast: {
      BalanceNotSupported: "当前渠道不支持余额查询",
      BalanceFormatFailed: "余额格式化失败",
      BalanceQueryFailed: "查询失败或不支持查询",
      BalanceQueryError: "查询余额失败",
      KeyCopied: "API 密钥已复制到剪贴板",
      CopyFailed: "复制失败",
      ParsingEmpty: "请输入需要解析的内容",
      ParsingSuccess: "解析成功",
      KeyEmpty: "API Key 不能为空",
      KeyNonStandard: "API Key 包含非标准字符，请先修正后再添加",
      KeyDuplicate: "所有 API Key 都已存在",
      KeysAdded: "已成功添加 {count} 个密钥",
      TestModelEmpty: "测试模型不能为空，请先指定测试用的模型",
      TestingProgress: "正在测试 {start}-{end} / 共 {total} 个密钥...",
      TestingDone: "已完成 {total} 个密钥的测试",
      KeyAutoDisabledStatus: "密钥已自动禁用 ({status}): {key}...",
      KeyAutoDisabledNetwork: "密钥已自动禁用 (网络错误): {key}...",
      KeyEnabled: "密钥已启用: {key}...",
      KeyDisabled: "密钥已禁用: {key}...",
      DisabledCleared: "已清除 {count} 个禁用的密钥",
      NoDisabledKeys: "没有禁用的密钥需要清除",
      CheckingKeys: "正在检查密钥...",
      TestingUntested: "测试 {count} 个未测试的密钥...",
      TestedProgress: "已测试 {progress}/{total} 个密钥...",
      InvalidRemoved: "已移除 {count} 个失败的密钥",
      NoInvalidKeys: "没有发现失败的密钥",
      FilteredRemoved: "已删除 {count} 个密钥",
      RefreshProgress: "正在刷新 {start}-{end} / 共 {total} 个密钥的余额...",
      RefreshDone: "所有余额刷新完成，当前渠道总额度：{currency} {amount}",
      RefreshNoBalance: "所有余额刷新完成，未查询到有效额度信息。",
      FetchModelsFailed: "获取模型列表失败: {error}",
      ModelTestFailed: "模型 {name} 测试失败: {msg}",
    },
    Confirm: {
      Unsaved: {
        Title: "可能有未保存的更改，是否要保存当前渠道的修改？",
        Danger: "此操作执行后无法撤回，是否继续？",
      },
      DeleteKey: {
        Title: "确定要删除此 API 密钥吗？",
      },
      RemoveInvalid: {
        Title: "此操作将会移除所有测试连接失败的密钥。",
        RemoveTitle: "将移除以下类型的密钥:",
        ItemTimeout: "API 连接超时的密钥",
        ItemAuthFailed: "验证失败的密钥",
        ItemModelUnavailable: "模型不可用的密钥",
        TestInfo: "测试信息:",
        TestModel: "测试模型:",
        ApiUrl: "接口地址:",
        Unspecified: "未指定",
      ...
      ClearDisabled: {
        ...
        RemoveTitle: "将移除以下密钥:",
        Count: "共 {count} 个密钥",
        Danger: "此操作不可撤销，请确认是否继续？",
      },
      DeleteFiltered: {
        Title: '确定要删除所有匹配 "{term}" 的 {count} 个密钥吗？',
        Danger: "此操作不可撤销",
        Including: "将删除 {count} 个密钥，包括: {keys} 等",
        AllKeys: "将删除: {keys}",
      },
    },
    NonAsciiError:
      "检测到异常字符: {details}{more}。可能是复制时带入的特殊符号，请检查并重新输入。",
    NonAsciiMore: " 等 {count} 个",
    EmptyKeys: {
      None: "尚未添加 API 密钥，请在上方添加第一个密钥。",
      NoMatching: '未找到匹配 "{term}" 的密钥',
    },
    ModelDescPlaceholder: "输入模型描述（可选）",
