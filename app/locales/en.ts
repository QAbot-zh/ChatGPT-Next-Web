...
\
  ...
  Settings: {
    ...
    CustomCSS: {
      ...
      PreviewApplied: "Temporary preview applied.",
      PreviewCancelled: "Preview cancelled.",
      PreviewEmpty: "Enter CSS or choose a cloud theme first.",
      CloudTheme: "Cloud Theme",
      CloudThemePlaceholder: "Choose a cloud theme",
      LocalThemeOption: "Restore Local Theme",
      LocalThemeRestored: "Local theme restored.",
      CloudThemeLoading: "Loading cloud themes...",
      CloudThemeLoadFailed: "Failed to load cloud themes",
      CloudThemeCssLoading: "Loading theme CSS...",
      PrimaryColor: "Primary",
      SecondaryColor: "Secondary",
      LightMode: "Light",
      DarkMode: "Dark",
      ThemeLoaded: (name: string) => `Loaded theme: ${name}`,
      ThemeLoadFailed: (name: string) => `Failed to load theme: ${name}`,
  ...
  CustomProvider: {
    ...
    CopyKey: "Copy key",
    TestKey: "Test API key connectivity",
    DeleteKeyTitle: "Delete key",
    TestModelLabel: "Test Model:",
    TestAllKeys: "Test All Keys",
    ServerProxy: {
      title: "Server Proxy",
      subtitle: "Forward requests via the server to bypass CORS",
    },
    ViewToggle: {
      List: "List",
      Card: "Card",
    ...
    Vision: {
      Enable: "Enable vision support",
      Disable: "Disable vision support",
      Enabled: "Enabled",
      Disabled: "Disabled",
    },
    ModelTest: {
      Title: "Test model availability",
      Testing: "Testing...",
      Failed: "Failed",
      ...
      ModelFailed: "Model {name} test failed: {msg}",
    },
    KeyTestStatus: {
      Testing: "Testing...",
      ErrorPrefix: "✗ Error",
    ...
    Toast: {
      BalanceNotSupported: "This channel does not support balance queries",
      BalanceFormatFailed: "Failed to format balance",
      BalanceQueryFailed: "Query failed or not supported",
      BalanceQueryError: "Failed to query balance",
      KeyCopied: "API key copied to clipboard",
      CopyFailed: "Copy failed",
      ParsingEmpty: "Please enter content to parse",
      ParsingSuccess: "Parsed successfully",
      KeyEmpty: "API Key cannot be empty",
      KeyNonStandard:
        "API Key contains non-standard characters, please fix before adding",
      KeyDuplicate: "All API keys already exist",
      KeysAdded: "{count} keys added successfully",
      TestModelEmpty:
        "Test model cannot be empty. Please specify a model to test with.",
      TestingProgress: "Testing keys {start}-{end} of {total}...",
      TestingDone: "All {total} keys tested.",
      KeyAutoDisabledStatus: "Key auto-disabled ({status}): {key}...",
      KeyAutoDisabledNetwork: "Key auto-disabled (network error): {key}...",
      KeyEnabled: "Key enabled: {key}...",
      KeyDisabled: "Key disabled: {key}...",
      DisabledCleared: "Removed {count} disabled keys",
      NoDisabledKeys: "No disabled keys to clear",
      CheckingKeys: "Checking keys...",
      TestingUntested: "Testing {count} untested keys...",
      TestedProgress: "Tested {progress}/{total} keys...",
      InvalidRemoved: "Removed {count} failed keys",
      NoInvalidKeys: "No failed keys found",
      FilteredRemoved: "Removed {count} keys",
      RefreshProgress:
        "Refreshing balances for keys {start}-{end} of {total}...",
      RefreshDone:
        "All balances refreshed. Total for this channel: {currency} {amount}",
      RefreshNoBalance:
        "All balances refreshed. No valid balance information found.",
      FetchModelsFailed: "Failed to fetch model list: {error}",
      ModelTestFailed: "Model {name} test failed: {msg}",
    },
    Confirm: {
      Unsaved: {
        Title: "There may be unsaved changes. Save current channel changes?",
        Danger: "This action cannot be undone. Continue?",
      },
      DeleteKey: {
        Title: "Are you sure you want to delete this API key?",
      },
      RemoveInvalid: {
        Title: "This will remove all keys that failed connection tests.",
        RemoveTitle: "The following types of keys will be removed:",
        ItemTimeout: "Keys with API connection timeout",
        ItemAuthFailed: "Keys that failed authentication",
        ItemModelUnavailable: "Keys with unavailable model",
        TestInfo: "Test info:",
      ...
      ClearDisabled: {
        Title: "Are you sure you want to clear all disabled keys?",
        RemoveTitle: "The following keys will be removed:",
        Count: "{count} keys total",
        Danger: "This action cannot be undone. Continue?",
      },
      DeleteFiltered: {
        Title: 'Delete all {count} keys matching "{term}"?',
        Danger: "This action cannot be undone",
        Including: "Will delete {count} keys, including: {keys} ...",
        AllKeys: "Will delete: {keys}",
      },
    },
    NonAsciiError:
      "Non-standard characters detected: {details}{more}. They may have been introduced when copying — please check and re-enter.",
    NonAsciiMore: " and {count} more",
    EmptyKeys: {
      None: "No API keys added. Add your first key above.",
      NoMatching: 'No keys matching "{term}"',
    },
    ModelDescPlaceholder: "Enter model description (optional)",
    TestMessage: "Hello. Please respond with 'OK'.",
  },
  URLCommand: {
